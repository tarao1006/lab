...
球形粒子の場合，式\eqref{nh}と\eqref{nbh}の和が0であるとして求まる$\dot{\gamma}$と，シミュレーション結果がよく一致していることが確認できた．
