...
udf.data['object_type']['spherical_particle']['particle_spec'][0]['janus_slip_vel'] = 0.02
udf.data['object_type']['spherical_particle']['particle_spec'][0]['janus_slip_mode'] = 25.0
