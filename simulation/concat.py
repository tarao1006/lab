...
if __name__ == "__main__":
    ...
    #     cv2.imwrite(f'figs/sim05/figs4movies/_{i:0=3.0f}.jpg', finish)

    subprocess.run(['ffmpeg', '-f', 'image2', '-r', '15', '-i', f'figs/sim05/figs4movies/_%03d.jpg', '-r', '15', '-an', '-vcodec', 'libx264', '-pix_fmt', 'yuv420p', 'video.mp4'])
